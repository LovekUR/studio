            ...
            <CardContent className="min-h-[400px]">
              ...
              {analysisResult && (
                <div className="space-y-6 animate-in fade-in duration-500">
                  ...
                  <div>
                    <h3 className="font-headline text-lg flex items-center mb-2">
                      <Bot className="mr-2 h-5 w-5" /> AI Feedback
                    </h3>
                    <p className="text-sm text-foreground/90 whitespace-pre-wrap font-body bg-muted/50 p-4 rounded-md">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground whitespace-pre-wrap font-body border p-4 rounded-md">
